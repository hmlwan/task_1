...
<div class="main-wrap">
    ...
    <div class="crumb-wrap">
        <div class="crumb-list"><i class="icon-font"></i><a href="<?php echo U('Index/index');?>">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">任务列表</span></div>
    </div>
    ...
    <div class="result-wrap">
        ...
        <div class="result-title">
            <div class="result-list">
                <a href="<?php echo U('PubTask/add');?>#6#0"><i class="icon-font"></i>新增发布任务</a>
            </div>
        </div>
