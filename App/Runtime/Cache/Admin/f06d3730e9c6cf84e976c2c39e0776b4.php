...
<div class="main-wrap">
    ...
    <div class="crumb-wrap">
        <div class="crumb-list"><i class="icon-font"></i><a href="<?php echo U('Index/index');?>">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">推广奖励记录</span></div>
    </div>
    ...
    <div class="result-wrap">
        ...
        <div class="search-content">
            <form action="<?php echo U('Transfer/promote_reward_record');?>" method="get">
        ...
        <div class="result-content">
            <table class="result-tab" width="100%">
                ...
                <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td><?php echo ($vo['finance_type_name']); ?></td>
                        <td><?php echo ($vo['money']); ?>
                            <?php if($vo['type'] == 1): ?>收入
                            <?php else: ?>
                                支出<?php endif; ?>
                        </td>
