						...
						<tbody>
							<tr>
								...
								<td><input type="text" id=""
									value="<?php echo ($config["CODE_USER_NAME"]); ?>" size="85"
									name="CODE_USER_NAME" class="common-text"></td>
							</tr>
							<tr>
								<th><i class="require-red">*</i>短信接口密码：</th>
								<td><input type="text" id=""
									value="<?php echo ($config["CODE_USER_PASS"]); ?>" size="85"
									name="CODE_USER_PASS" class="common-text"></td>
							</tr>
							<tr>
								<th><i class="require-red">*</i>短信接口发送标题：</th>
								<td><input type="text" id="" value="<?php echo ($config["CODE_NAME"]); ?>"
									size="85" name="CODE_NAME" class="common-text"></td>
							</tr>
                             <tr>
								<th><i class="require-red">*</i>短信网关地址：</th>
								<td><input type="text" id="" value="<?php echo ($config["CODE_GATE"]); ?>"
									size="85" name="CODE_GATE" class="common-text"></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td><input type="text" id="" value="<?php echo ($config["EMAIL_HOST"]); ?>"
									size="85" name="EMAIL_HOST" class="common-text"></td>
							</tr>
							<tr>
								<th><i class="require-red">*</i>邮局用户名(请填写完整的email地址)：</th>
								<td><input type="text" id=""
									value="<?php echo ($config["EMAIL_USERNAME"]); ?>" size="85"
							...
							<tr>
								...
								<td><input type="text" id=""
									value="<?php echo ($config["EMAIL_PASSWORD"]); ?>" size="85"
