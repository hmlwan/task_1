...
$(".sub-menu").eq(num[1]).children("li").eq(num[2]).addClass("on");
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="<?php echo U('Index/index');?>">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">审核列表</span></div>
        </div>
		<div class="search-wrap">
            <div class="search-content">
                <form action="<?php echo U('Member/auth_list');?>" method="post">
            ...
            <div class="result-content">
                <table class="result-tab" width="100%">
                    ...
                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td>
                            	<a href="<?php echo ($vo["img"]); ?>" target = '_blank' title="点击查看大图">
                            		<img src="<?php echo ($vo["img"]); ?>" style="width:100px;height:100px;"/>
                            	</a>
                            </td>
                            ...
                            <td>
                            	<?php if($vo['status'] == 0 or $vo['status'] == 2 or $vo['status'] == 3): ?><a class="link-del" href="<?php echo U('Member/add_member_priority',array('status'=>1, 'id'=>$vo['id']));?>">通过</a>
									<a class="link-del" href="<?php echo U('Member/auth_do',array('status'=>3, 'id'=>$vo['id']));?>" onclick="return confirm('确认继续操作吗？')">拒绝</a>
								<?php else: ?>
								暂无<?php endif; ?>
                            </td>
