...
<div class="main-wrap">
    <div class="crumb-wrap">
        <div class="crumb-list"><i class="icon-font"></i><a href="<?php echo U('Index/index');?>">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">会员账户信息</span></div>
    </div>
    <div class="result-wrap">

        <form action="<?php echo U('Member/show');?>" method="post"  enctype="multipart/form-data">
            <div class="config-items">
                <div class="result-content">
					...
					<input type="hidden" value="<?php echo ($member_id); ?>" name="member_id" />
						...
						<tr>
                             <th>支付宝收款码上传：</th>
            				 <td><input type="file" name="alipay_logo"  style="width:200px;" />
									<img src="<?php echo ($list['alipay_logo']); ?>" style="width:50px;height:auto" />
									<input type="hidden" name="alipay_logoold" value="<?php echo ($list['alipay_logo']); ?>" />
							</td>
                        </tr>
                        <tr>
                            <th>微信收款码上传：</th>
                            <td><input type="file" name="wechat_logo"  style="width:200px;" />
                                <img src="<?php echo ($list['wechat_logo']); ?>" style="width:50px;height:auto" />
                                <input type="hidden" name="wechat_logoold" value="<?php echo ($list['wechat_logo']); ?>" />
                            </td>
                        </tr>
                        <tr>
                            <th> 星星数：</th>
