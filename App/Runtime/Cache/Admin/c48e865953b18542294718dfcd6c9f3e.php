...
<div class="main-wrap">
    ...
    <div class="crumb-wrap">
        <div class="crumb-list"><i class="icon-font"></i><a href="<?php echo U('Index/index');?>">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">复购记录</span></div>
    </div>
    ...
    <div class="result-wrap">
        ...
        <div class="search-content">
            <form action="<?php echo U('Trade/re_buy_record');?>" method="get">
                <table class="search-tab">
                    <tr>
                        <td width="50">用户名:</td>
                        <td><input class="common-text" placeholder="用户名" name="username" type="text" value="<?php echo ($_GET['username']); ?>"></td>
        ...
        <div class="result-content">
            <table class="result-tab" width="100%">
                ...
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td><?php echo ($vo['task_title']); ?></td>
                        <td><?php echo ($vo['useraname']); ?></td>
                        <td><?php echo ($vo['sk_name']); ?>
                            <?php if($vo['type'] == 1): ?>执行者
                                <?php else: ?>
                                付款者<?php endif; ?>
                        </td>
