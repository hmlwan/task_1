...
<div class="main-wrap">
    ...
    <div class="result-wrap">
        <form action="<?php echo U('Manage/pwdUpdate');?>" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    ...
                    <table width="100%" class="insert-tab">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="<?php echo U('Manage/index');?>"><input type="button" value="返回"  class="btn btn6"></a>
                            </td>
                        </tr>
                        </tbody></table>
                </div>
