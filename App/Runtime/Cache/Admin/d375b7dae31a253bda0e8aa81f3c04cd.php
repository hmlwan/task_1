					...
					<input type="hidden" value="<?php echo ($list['member_id']); ?>" name="member_id" />
                        ...
                        <tr>
						 ...
						 <tr>
                            <th>状态</th>
                            <td>
                                <input type="radio" value="1" <?php if($list['is_lock'] == 1): ?>checked="checked"<?php endif; ?> name="is_lock" />&nbsp;禁用
                                <input type="radio" value="0" <?php if($list['is_lock'] == 0): ?>checked="checked"<?php endif; ?> name="is_lock" />正常
                            </td>
                        </tr>
                        <th></th>
                        <td>
