...
<div class="main-wrap">
    ...
    <div class="crumb-wrap">
        <div class="crumb-list"><i class="icon-font"></i><a href="<?php echo U('Index/index');?>">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">转账配置管理</span></div>
    </div>
    ...
    <div class="result-wrap">
        ...
        <div class="search-content">
            <form action="<?php echo U('Transfer/record');?>" method="get">
