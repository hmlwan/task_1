        ...
        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="new_item">
                <div class="new_fb">
                    ...
                    <p class="ss_status">
                        <span>搜索状态</span>
                        <span class="op_res">
                            <?php if($vo['qd_status'] == 1): ?><a href="<?php echo U('Trade/pay_fk',array('task_id'=>$vo['id'],'status'=>2));?>">搜索成功</a>
                            <?php elseif($vo['qd_status'] == 2): ?>
                                搜索中
                            <?php elseif($vo['qd_status'] == 3): ?>
                                 <a href="<?php echo U('Trade/pay_fk',array('task_id'=>$vo['id'],'status'=>3));?>">已被拒绝</a>
                            <?php else: ?>
                                ---<?php endif; ?>
                        </span>
                    </p>
                ...
                <div class="new_sq">
                    ...
                    <p class="ss_status">
                        <span>搜索状态</span>
                        <span class="op_res">
                            <?php if($vo['sk_status'] == 1): ?><a href="<?php echo U('Trade/pay_sk',array('task_id'=>$vo['id'],'status'=>2));?>">搜索成功</a>
                            <?php elseif($vo['sk_status'] == 2): ?>
                                搜索中
                             <?php elseif($vo['sk_status'] == 3): ?>
                                  <a href="<?php echo U('Trade/pay_sk',array('task_id'=>$vo['id'],'status'=>3));?>">已拒绝</a>
                             <?php else: ?>
                                ---<?php endif; ?>
                        </span>
                    </p>
