...
<div class="zfyj">
    <header>
        <div class="gwc_bt">
            <div class="gwcbt_fh"><a href="<?php echo U('Index/index');?>" class="gwcdd_fh"></a></div>
...
<script>
    ...
    function sub() {
        ...
        $.post("<?php echo U('FullInfo/pay_pub');?>",{pay_money:pay_money,pay_type:pay_type,task_id:task_id,type:type},function(data){
            if(data.status > 0){
