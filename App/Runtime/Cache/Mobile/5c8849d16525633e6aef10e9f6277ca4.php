            ...
            <dl>
                <dd class="tdxx_menu">
                    <ul>
                        ...
                        <li>会员类型</li>
                        <li style="width: 15%">次数</li>
                        <li style="width: 15%">星星</li>
                    </ul>
                </dd>
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><dd>
                        <ul>
                            ...
                            <li><?php if($vo['is_pay_deposit'] == 1): ?>任务执行者
                                <?php else: ?>
                                非任务执行者<?php endif; ?></li>
                            <li style="width: 15%"><?php echo ($vo["fg_num"]); ?></li>
                            <li style="width: 15%"><?php echo ($vo["stars"]); ?></li>
                        </ul>
