...
/**/
			if($_FILES["idcardpositive"]["tmp_name"]){
				$data['idcardpositive'] = $this->upload($_FILES["idcardpositive"]);
			}
			if($_FILES["idcardside"]["tmp_name"]){
				$data['idcardside'] = $this->upload($_FILES["idcardside"]);
			}
			if($_FILES["idcardhold"]["tmp_name"]){
				$data['idcardhold'] = $this->upload($_FILES["idcardhold"]);
			}
