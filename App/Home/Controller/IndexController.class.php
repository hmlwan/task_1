...
class IndexController extends CommonController {
	...
	public function index(){
		...
		foreach ($currency as $k=>$v){
			...
			$currency[$k]['currency_all_money'] = getFloatToNum($v['currency_all_num'])*$list['new_price'];
...
//            $arr[$i] = $all_money[$i];
        ...
        //*******众筹end*******/////
        //*******币时代官方公告begin*******/////
        $bsdtitle=$this->getArticleCategoryNameById(127);
        $bsd=$this->getArticleByPositionid(127);
        $this->assign('bsd',$bsd);
        $this->assign('bsdtitle',$bsdtitle);
        //*******币时代官方公告end*******/////
        //*******比特币资讯begin*******/////
        $btbtitle=$this->getArticleCategoryNameById(128);
        $btb=$this->getArticleByPositionid(128);
        $this->assign('btb',$btb);
        $this->assign('btbtitle',$btbtitle);
        //*******比特币资讯end*******/////
        //*******山寨币资讯begin*******/////
        $szbtitle=$this->getArticleCategoryNameById(129);
        $szb=$this->getArticleByPositionid(129);
        $this->assign('szb',$szb);
        $this->assign('szbtitle',$szbtitle);
        //*******山寨币资讯end*******/////
