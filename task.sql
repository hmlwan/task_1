...
CREATE TABLE `blue_member_trade_record` (
  ...
  `add_time` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='用户资金交易记录表';

-- ----------------------------
-- Records of blue_member_trade_record
-- ----------------------------
INSERT INTO `blue_member_trade_record` VALUES ('1', '1', '1', '1', '200.00', '0.00', '1552828106');
INSERT INTO `blue_member_trade_record` VALUES ('2', '2', '1', '2', '200.00', '20.00', '1552828106');
...
INSERT INTO `blue_nav` VALUES ('19', '交易记录', '&#xe608;', '/Trade/jy_record', 'trade');
